    ...
    return (
      <React.Fragment>
        <div className="container mt-3">
          <div className="row">
            <div className="col">{fillSpace[0]}{hasCorrectNum[1]}{fillSpace[2]}</div> {/* 1st Line */}
          </div>
          <div className="row">
        ...
        <div className="container mt-3">
          <div className="row">
            <div className="col">{fillSpace[2]}{fillSpace[1]}{hasCorrectNum[2]}</div> {/* 2nd Line */}
          </div>
          <div className="row ">
            <div className="col">One Number is Correct and Well Placed</div>
          </div>
        ...
        <div className="container mt-3">
          <div className="row">
            <div className="col">{fillSpace[0]}{hasCorrectNum[0]}{fillSpace[1]}</div> {/* 3rd Line */}
          </div>
          <div className="row">
        ...
        <div className="container mt-3">
          <div className="row">
            <div className="col">{oppositeNum[2]}{hasCorrectNum[0]}{hasCorrectNum[2]}</div> {/* 4th Line */}
          </div>
          <div className="row">
            <div className="col">
        ...
        <div className="container mt-3">
          <div className="row">
            <div className="col">{oppositeNum[0]}{oppositeNum[1]}{oppositeNum[2]}</div> {/* 5th Line */}
          </div>
          <div className="row">
